...
class ObjectRecognition:
    ...
    def is_red_present(self):
        ...
        mask0 = cv2.inRange(self.hsv_image, red_lower, red_upper)
        red_lower = np.array([170, 50, 50])
        red_lower = np.array([180, 255, 255])
        mask1 = cv2.inRange(self.hsv_image, red_lower, red_upper)
        mask = mask0 + mask1
    ...
    def find_object_callback(self, msg: DetectionInfo):
        ...
        for key in self.objects.obj_dict:
            ...
            for __, pos in enumerate(obj):
                ...
                marker.ns = key
                marker.id = 0
                #marker.mesh_resource = "package://rssproject/src/meshes/alive.dae"
                ...
                if key==Objects.ALIVE:
                            ...
                            marker.mesh_resource = "package://rssproject/src/meshes/dead.dae"

                elif key==Objects.BIOHAZARD:
                            marker.mesh_resource = "package://rssproject/src/meshes/biohazard.dae"
                        
                elif key==Objects.DANGER:
                            marker.mesh_resource = "package://rssproject/src/meshes/danger.dae"

                elif key==Objects.FLAMABLE:
                            marker.mesh_resource = "package://rssproject/src/meshes/flamable.dae"

                elif key==Objects.NOSMOKING:
                            marker.mesh_resource = "package://rssproject/src/meshes/nosmoking.dae"

                elif key==Objects.RADIOACTIVE:
                            marker.mesh_resource = "package://rssproject/src/meshes/radioactive.dae"

                elif key==Objects.REDTRIANGLE:
                            marker.mesh_resource = "package://rssproject/src/meshes/redtriangle.dae"   

                elif key==Objects.TOXIC:
                            marker.mesh_resource = "package://rssproject/src/meshes/toxic.dae" 
