...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/nivanpc/RSSGroupProject/catkin_ws/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/nivanpc/RSSGroupProject/catkin_ws/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/nivanpc/RSSGroupProject/catkin_ws/install)
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nivanpc/RSSGroupProject/catkin_ws/src/m-explore/map_merge/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(multirobot_map_merge_EXPORTED_TARGETS ${${multirobot_map_merge_dep}_EXPORTED_TARGETS})
endforeach()
